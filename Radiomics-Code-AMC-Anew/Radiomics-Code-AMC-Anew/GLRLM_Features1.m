function[ stats , tGLRLM ] = GLRLM_Features1(varargin)
...
% varargin = uint8(GLRLM)
% varargin = (GRLRM_4)

% Check GLRLM
[GLRLM numGLRLM] = ParseInputs((varargin{:})); % numGLRLM : 2d = 4, 3d = 13 
...
GLRLMori = zeros(size(GLRLM{1},1),size(GLRLM{1},2));
for p = 1 : numGLRLM
    ...
    GLRLMori = GLRLM{p} + GLRLMori;
end
    
    finalMatrix=GLRLMori/numGLRLM;    
    tGLRLM = finalMatrix;
...
% ====================================================================
    ...
    stats=[SRE LRE GLN RLN  RP LGRE HGRE SGLGE SRHGE LRLGE  LRHGE N_runs];
